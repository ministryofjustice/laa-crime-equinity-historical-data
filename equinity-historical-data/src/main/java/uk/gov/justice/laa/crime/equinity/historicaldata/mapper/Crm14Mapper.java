...
public interface Crm14Mapper extends CrmMapper {
    ...
    @Mapping(target="you.childBenefit", source="child_benefit_calc")
    @Mapping(target="you.childBenefitPaidEvery", source="child_benefit_paid_every")
    @Mapping(target="you.taxCreditsAmount", source="tax_credits_calc")
    @Mapping(target="you.taxCreditsPaidEvery", source="tax_credits_paid_every")
    @Mapping(target="you.universalCredit", source="universal_credit_calc")
    @Mapping(target="you.universalCreditPaidEvery", source="universal_credit_paid_every")
    @Mapping(target="you.otherBenefitsCalc", source="other_benefits_calc")
    ...
    @Mapping(target="partner.wageCalc", source="partner_wage_calc")
    ...
    @Mapping(target="partner.childBenefit", source="partner_child_benefit_calc")
    @Mapping(target="partner.childBenefitPaidEvery", source="partner_child_benefit_paid_every")
    @Mapping(target="partner.taxCreditsAmount", source="partner_tax_credits_calc")
    @Mapping(target="partner.taxCreditsPaidEvery", source="partner_tax_credits_paid_every")
    @Mapping(target="partner.universalCredit", source="partner_universal_credit_calc")
    @Mapping(target="partner.universalCreditPaidEvery", source="partner_universal_credit_paid_every")
    @Mapping(target="partner.otherBenefitsCalc", source="partner_other_benefits_calc")
