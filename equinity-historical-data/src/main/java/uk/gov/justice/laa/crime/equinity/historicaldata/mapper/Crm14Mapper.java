...
public interface Crm14Mapper extends CrmMapper {
    ...
    @Mapping(target = "evidencePart2.pseTlMessages", source="pseTLMessages")
    ...
    @Mapping(target = "declarationStatement2", source="legal_rep_declaration_2")
    ...
    @Mapping(target="you.childBenefitPaidEvery", source="child_benefit_paid_every")
    @Mapping(target="you.taxCreditsAmount", source="tax_credits_amount")
    @Mapping(target="you.taxCreditsPaidEvery", source="tax_credits_paid_every")
    @Mapping(target="you.universalCreditAmount", source="universal_credit")
    @Mapping(target="you.universalCreditPaidEvery", source="universal_credit_paid_every")
    @Mapping(target="you.otherBenefitsAmount", source="other_benefits")
    @Mapping(target="you.otherBenefitsPaidEvery", source="other_benefits_paid_every")
    @Mapping(target="you.maintenancePayment", source="maintenance_payment")
    @Mapping(target="you.maintenancePaymentPaidEvery", source="maintenance_payment_paid_every")
    @Mapping(target="you.pensionsAmount", source="pensions")
    @Mapping(target="you.pensionsPaidEvery", source="pensions_paid_every")
    @Mapping(target="you.otherIncomeAmount", source="other_income")
    ...
    @Mapping(target="you.otherIncomeRentFromFamily", source="other_income_rent_from_family")
    @Mapping(target="you.otherIncomeRental", source="other_income_rental")
    ...
    @Mapping(target="partner.childBenefitPaidEvery", source="partner_child_benefit_paid_every")
    @Mapping(target="partner.taxCreditsAmount", source="partner_tax_credits_amount")
    @Mapping(target="partner.taxCreditsPaidEvery", source="partner_tax_credits_paid_every")
    @Mapping(target="partner.universalCreditAmount", source="partner_universal_credit")
    @Mapping(target="partner.universalCreditPaidEvery", source="partner_universal_credit_paid_every")
    @Mapping(target="partner.otherBenefitsAmount", source="partner_other_benefits")
    @Mapping(target="partner.otherBenefitsPaidEvery", source="partner_other_benefits_paid_every")
    @Mapping(target="partner.maintenancePayment", source="partner_maintenance_payment")
    @Mapping(target="partner.maintenancePaymentPaidEvery", source="partner_maintenance_payment_paid_every")
    @Mapping(target="partner.pensionsAmount", source="partner_pensions")
    @Mapping(target="partner.pensionsPaidEvery", source="partner_pensions_paid_every")
    @Mapping(target="partner.otherIncomeAmount", source="partner_other_income")
    ...
    @Mapping(target="income1.nonCashBenefit", source="non_cash_benefit")
    @Mapping(target="income1.partnerNonCashBenefit", source="partner_non_cash_benefit")
    @Mapping(target="income1.nonCashBenefitValue", source="non_cash_benefit_value")
    @Mapping(target="income1.partnerNonCashBenefitValue", source="partner_non_cash_benefit_value")
    ...
    @Mapping(target="dtProcessed", expression = "java(null)")
    ...
    @Mapping(target="dtProcessed", source="processed")
    ...
    @Mapping(target="dtSubmitted", source="dtLastActedOn")
    @Mapping(target="message", source="tlmessage")
    Crm14PseMessageDTO getCrm14PseTlMessagesFromModel(Crm14PSEMessagesModel pseTlMessagesModel);
