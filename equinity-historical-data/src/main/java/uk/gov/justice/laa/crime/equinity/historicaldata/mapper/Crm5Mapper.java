...
public interface Crm5Mapper {
    ...
    @Mapping(target="courtAppealFunding.appealDetails", source="caf_client_has_cop_rep_order")
    @Mapping(target="courtAppealFunding.benefitOfCourt", source="caf_court_funding_details")
    ...
    @Mapping(target="caseHistory.addtionalInfo", source="ch_additional_info")
